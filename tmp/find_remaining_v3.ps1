...
$eraRegex = '\b\d{2}''?s\b|nineties|eighties|seventies|sixties|fifties|\bera\b|\bdecade\b|century|millennium'
...
$outputLines | Set-Content -Path 'c:\Users\kishi\OneDrive\Documents\music_game_v2\tmp\remaining_clues_v3.txt' -Encoding utf8
